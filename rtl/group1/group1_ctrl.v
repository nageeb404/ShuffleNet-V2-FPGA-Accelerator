...
// computation cores. And the addresses for the Filter memory." -- Sec 5.3.4.2
//
...
module group1_ctrl (
    ...
    // -------------------------------------------------------------------------
    // FSM state codes from fifo_ctrl.v (Sec 5.3.4.1)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // Output assignments -- purely combinational (counters + logic, Sec 5.3.4.2)
    // -------------------------------------------------------------------------
