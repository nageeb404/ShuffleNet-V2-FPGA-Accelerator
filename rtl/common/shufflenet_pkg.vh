...
// -----------------------------------------------------------------------------
//, Table 4.4 (final selection on 50,000 ImageNet photos):
// "15 / 6 / 8" -> 15-bit width, 6 integer bits, 8 fractional bits.
// confirms: "we synthesis the model with fixed point data type
// with 15-bit width and 8-bit fraction."
// confirms baseline format applies to photo memory too:
// "we use a 15-bit fixed point (8-bit fraction) representation in this
// architecture, the input photo pixels are represented in the same way too."
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//: "The multipliers double the number of bits from 15 to 30
...
// -----------------------------------------------------------------------------
//: "the 3-input adder increments the number of bits by 2 and
// the 2-input adder increments the number of bits by 1."
//: "the accumulator increments the number of bits by
...
// -----------------------------------------------------------------------------
// Group 1: 3x3 Convolution [Sec 5.3.2.1, T5.1]
...
// Group 3: Fully Connected [Sec 5.5.1.3, T5.11]
`define G3_FC_PAR_CHAN       32

// -----------------------------------------------------------------------------
// 5) Network dimensions
// -----------------------------------------------------------------------------
// Input image ():
...
// Group 1 3x3 Conv FIFO depth (Sec 5.3.3):
...
// Group 1 Maxpool FIFO depth (Sec 5.3.3):
...
// Group 2 one-fits-all FIFO depth (Sec 5.4.6):
