...
// quantization-noise drop after the multiplier is
...
module quantizer #(
 ...
 // -------------------------------------------------------------------------
 // Maximum-check "simple logic" (per)
 // -------------------------------------------------------------------------
 // Define:
 ...
 // -------------------------------------------------------------------------
 // Minimum-check (per) - only when HAS_RELU == 0
 // -------------------------------------------------------------------------
 ...
 // (The confirms accumulation/adders only grow the integer side, the
