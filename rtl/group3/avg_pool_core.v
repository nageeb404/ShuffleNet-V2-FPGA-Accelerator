...
// -----------------------------------------------------------------------------
// "Group 3 Design" / Table 5.10, Figures 5.58, 5.59
// "Remove avgpool division":
...
// (coupled): the 1x1 conv before avgpool now outputs 35-bit
// full-precision values (no inter-stage quantizer), so IN_W = G3_CONV_OUT_W.
//
// Table 5.10 (Parallelism in Average Pooling, Group 3):
