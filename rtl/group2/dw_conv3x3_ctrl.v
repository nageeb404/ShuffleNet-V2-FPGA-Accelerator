...
// -----------------------------------------------------------------------------
// "3by3 DWconv Controller" / Figures 5.44, 5.46, 5.47
//
...
// processed data either in the X_Left or X_Right memories." -- Sec 5.4.7.2
//
// DESIGN NOTE:
// 4 FSM states (IDLE/LEFT_S2/RIGHT_S1/RIGHT_S2) correspond to different
// Shuffle Unit invocations with different memory routing. This module
// implements the CORE SEQUENCING LOGIC (IDLE/RUNNING)
...
module dw_conv3x3_ctrl #(
    ...
    // Output memory interface ( / Fig 5.47)
