...
// -----------------------------------------------------------------------------
// "1by1 Conv Controller" / Figures 5.48, 5.49, 5.50
//
...
// acc_clr, and addresses." -- Sec 5.4.7.3
//
// DESIGN NOTE:
// 7 control states (IDLE/S2_Right_1st/Left_1st/S1_Right_1st/
// Right_2nd/Write_Sh_data/Write_Extra_Mem) route the 1x1 conv output to
...
module conv1x1_ctrl #(
    ...
    // Output memory interface ( / Fig 5.50)
