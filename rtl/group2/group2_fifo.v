...
// registers." -- (W_max = 58 = 56 feature map cols + 2 padding)
...
module group2_fifo #(
 ...
 input wire [1:0] width_sel, // 00=W7 01=W14 10=W28 11=W56
 ...
 // -------------------------------------------------------------------------
 // Row 0: always positions 0, 1, 2 ( -- "first three outputs are
