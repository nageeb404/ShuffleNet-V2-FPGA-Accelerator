# sim_tb_conv3x3_filter_unit.tcl -- Thesis Sec 5.3.2.1 / Fig 5.8
...
sim_run_tb \
    ...
    [file join $tb_dir tb_conv3x3_filter_unit.v] \
    [file join $tb_dir vectors conv3x3_filter_unit_vectors.hex] \
