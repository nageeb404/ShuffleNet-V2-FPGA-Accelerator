# sim_tb_dw_conv3x3_filter_unit.tcl -- Thesis Sec 5.4.1.1 / Fig 5.17
...
sim_run_tb \
    ...
    [file join $tb_dir tb_dw_conv3x3_filter_unit.v] \
    [file join $tb_dir vectors dw_conv3x3_filter_unit_vectors.hex] \
