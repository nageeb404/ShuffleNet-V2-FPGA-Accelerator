...
set _work [file join $_proj_root vivado work tb_g3_pw_weight_rom]
file mkdir $_work
catch {file copy -force [file join $hex_dir g3_pw_weights.hex] $_work}
sim_run_tb tb_g3_pw_weight_rom \
    [list [file join $rtl_dir g3_pw_weight_rom.v]] \
    [file join $tb_dir tb_g3_pw_weight_rom.v] "" [list $common_dir $rtl_dir]
