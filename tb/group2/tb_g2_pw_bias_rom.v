...
// ROM test: g2_pw_bias_rom (distributed, 16 entries, 754 bits)
module tb_g2_pw_bias_rom;
    reg [3:0] addr=0;
    wire [753:0] data_out;
    g2_pw_bias_rom dut(.addr(addr),.data_out(data_out));
    integer pass_cnt=0, fail_cnt=0, total=0;
    initial begin
        $display("=== tb_g2_pw_bias_rom ===");
        #2;
        total=total+1;
